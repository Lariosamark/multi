        ...
        <div className="p-8 border-b border-slate-700/50">
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              ...
              <p className="text-sm text-slate-400">Sales Platform</p>
            </div>
          </div>
        </div>
        ...
        <nav className="flex flex-col p-8 gap-6 flex-1">
          ...
          >
            <div className="w-14 h-14 bg-slate-800 rounded-xl flex items-center justify-center group-hover:bg-blue-600/20 transition-colors shadow-lg">
              <svg className="w-7 h-7 text-slate-400 group-hover:text-blue-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-slate-500 group-hover:text-slate-400">Create and manage new quotations for your clients</p>
            </div>
            <svg className="w-5 h-5 text-slate-500 ml-auto group-hover:text-slate-300 opacity-0 group-hover:opacity-100 transition-all duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
          ...
          >
            <div className="w-14 h-14 bg-slate-800 rounded-xl flex items-center justify-center group-hover:bg-green-600/20 transition-colors shadow-lg">
              <svg className="w-7 h-7 text-slate-400 group-hover:text-green-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="flex-1">
              ...
              <p className="text-sm text-slate-500 group-hover:text-slate-400">View, and track all your existing quotations</p>
            </div>
            <svg className="w-5 h-5 text-slate-500 ml-auto group-hover:text-slate-300 opacity-0 group-hover:opacity-100 transition-all duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" />
            </svg>
